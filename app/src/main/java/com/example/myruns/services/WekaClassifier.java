...
// Attempt 2 - Weka Classifier (Retrained)
class WekaClassifier {
    ...
    public static double classify(Object[] i)
        ...
        double p = Double.NaN;
        p = WekaClassifier.N7276b4670(i);
        return p;
    }
    static double N7276b4670(Object []i) {
        double p = Double.NaN;
        if (i[0] == null) {
            p = 0;
            ...
            p = WekaClassifier.N587587811(i);
        }
        return p;
    }
    static double N587587811(Object []i) {
        double p = Double.NaN;
        if (i[64] == null) {
            p = 1;
        } else if (((Double) i[64]).doubleValue() <= 14.534508) {
            p = WekaClassifier.N2c9e85e02(i);
        } else if (((Double) i[64]).doubleValue() > 14.534508) {
            p = 2;
        }
        return p;
    }
    static double N2c9e85e02(Object []i) {
        double p = Double.NaN;
        if (i[4] == null) {
            p = 1;
        } else if (((Double) i[4]).doubleValue() <= 14.034383) {
            p = WekaClassifier.N3d461dd73(i);
        } else if (((Double) i[4]).doubleValue() > 14.034383) {
            p = 1;
        }
        return p;
    }
    static double N3d461dd73(Object []i) {
        double p = Double.NaN;
        if (i[7] == null) {
            p = 1;
...
// Attempt 1 - Weka Classifier (Initial Attempt)
//class WekaClassifier {
//
//    public static double classify(Object[] i)
//            throws Exception {
...
// This is the professor's WekaClassifier
//class WekaClassifier {
//
//    public static double classify(Object[] i)
//            throws Exception {
